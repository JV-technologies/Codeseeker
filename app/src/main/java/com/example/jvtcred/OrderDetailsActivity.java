...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    private TextView totalItems, totalItemsPrice, totalAmount, savedAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //cancelDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);//dialog widh and height
        /////cancel dilaog
        ...
        switch (model.getOrderStatus()) {
            ...
            case "Packed":
                orderedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.baby)));
                orderedDate.setText(String.valueOf(simpleDateFormat.format(model.getOrderedDate())));
            ...
            case "Course Confirmed":
                ...
                deliveredTitle.setText("Course Confirmed");
                deliveredBody.setText("Your Course is now Confirmed.");
                    ...
                    FirebaseFirestore.getInstance().runTransaction(new Transaction.Function<Object>() {
                        ...
                        public Object apply(@NonNull Transaction transaction) throws FirebaseFirestoreException {
                            ...
                            if (rating != 0) {
                                ...
                                Long increase = documentSnapshot.getLong(starPosition + 1 + "_star") + 1; //user first time rating
                                transaction.update(documentReference, starPosition + 1 + "_star", increase); //updating
                            }
                            return null;
                        }
        ...
        if (model.isCancellationRequested()) {
            ...
            cancelOrderBtn.setTextColor(getResources().getColor(R.color.headings));
                    ...
                    public void onClick(View v) {
                        ...
                        cancelDialog.findViewById(R.id.yes_btn).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                map.put("Ordered Cancelled", false);
        ...
        if (!model.getCuttedPrice().equals("")) {
            if (!model.getDiscountedPrice().equals("")) {
                savedAmount.setText("You saved Rs." + model.getProductQuantity() * (Long.valueOf(model.getCuttedPrice()) - Long.valueOf(model.getDiscountedPrice())) + " on this course");
            } else {
                savedAmount.setText("You saved Rs." + model.getProductQuantity() * (Long.valueOf(model.getCuttedPrice()) - Long.valueOf(model.getProductPrice())) + " on this course");

            }
        } else {
            if (!model.getDiscountedPrice().equals("")) {
                savedAmount.setText("You saved Rs." + model.getProductQuantity() * (Long.valueOf(model.getProductPrice()) - Long.valueOf(model.getDiscountedPrice())) + " on this course");

            } else {
                savedAmount.setText("You saved Rs. 0/- on this course");
