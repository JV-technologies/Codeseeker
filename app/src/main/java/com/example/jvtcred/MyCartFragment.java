...
public class MyCartFragment extends Fragment {
            ...
            public void onClick(View v) {
                ...
                for (int x=0; x< DBqueries.cartItemModelList.size();x++){
                    ...
                    if (cartItemModel.isInStock()){
                        DeliveryActivity.cartItemModelList.add(cartItemModel); //if instock we will show the courses in the deliveryActivty cartaitemVIEW//
                    }
                }
    ...
    public void onStart() {
        ...
        if (DBqueries.rewardModelList.size()==0){
            loadingDialog.show();  ////loading the reward model list////
