...
public class MyAccountFragment extends Fragment {
    ...
    private TextView yourRecentOrdersTitles;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        yourRecentOrdersTitles = view.findViewById(R.id.your_recent_orders_titles);
        ...
        if (!DBqueries.profile.equals("")) {
            Glide.with(getContext()).load(DBqueries.profile).apply(new RequestOptions().placeholder(R.drawable.ic_anu_hollow)).into(profileView);
        }
        ...
        loadingDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                ...
                for (MyOrderItemModel orderItemModel : DBqueries.myOrderItemModelList) {
                    if (!orderItemModel.isCancellationRequested()) {
                        if (!orderItemModel.getOrderStatus().equals("Delivered") && !orderItemModel.getOrderStatus().equals("Cancelled")) {
                            ...
                            Glide.with(getContext()).load(orderItemModel.getProductImage()).apply(new RequestOptions().placeholder(R.drawable.ic_home_hollow)).into(currentOrderImage);
                ...
                for (MyOrderItemModel myOrderItemModel : DBqueries.myOrderItemModelList) {
                    if (i < 4) {
                        if (myOrderItemModel.getOrderStatus().equals("Delivered")) {
                            Glide.with(getContext()).load(myOrderItemModel.getProductImage()).apply(new RequestOptions().placeholder(R.drawable.ic_home_hollow)).into((CircleImageView) recentOrdersContainer.getChildAt(i));
                            i++;
                        }
                ...
                if (i == 0) {
                    yourRecentOrdersTitles.setText("No recent orders.");
                }
                if (i < 3) {
                    for (int x = 1; x < 4; x++) {
